      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for ( int i = 0; i < sensor_fusion.size(); i++ ) {
            ...
            if ( d > 0 && d < 4 ) {
                other_car_lane = 0; // left lane
            } else if ( d > 4 && d < 8 ) {
                other_car_lane = 1; // middle lane
            } else if ( d > 8 && d < 12 ) {
                other_car_lane = 2;
            } else continue;
            ...
            if ( other_car_lane == lane ) {
              ...
              car_ahead |= check_car_s > car_s && check_car_s - car_s < safety_distance;
            } else if ( other_car_lane - lane == -1 ) {
              // Other car is on the left lane
              car_left |= car_s - safety_distance < check_car_s && car_s + safety_distance > check_car_s;
            } else if ( other_car_lane - lane == 1 ) {
              // Other car is on the right lane
              car_right |= car_s - safety_distance < check_car_s && car_s + safety_distance > check_car_s;
            }
          }
